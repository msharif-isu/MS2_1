...
public class MainActivity extends AppCompatActivity {
    ...
    private Button pictureButton; // define addPicture button variable

    private ImageView picture; // define picture
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        picture = findViewById(R.id.profilePicture); // Link to picture image
        pictureButton = findViewById(R.id.main_addPic_btn); // Link to add picture
        ...
        /* click listener on add Profile Picture button pressed */
