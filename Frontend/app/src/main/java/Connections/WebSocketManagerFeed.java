 ...
 */
public class WebSocketManagerFeed {

    private static WebSocketManagerFeed instance;
    private MyWebSocketClient webSocketClient;
    private WebSocketListener webSocketListener;


    private WebSocketManagerFeed() {}
     ...
     */
    public static synchronized WebSocketManagerFeed getInstance() {
        if (instance == null) {
            instance = new WebSocketManagerFeed();
        }
        return instance;
    }
